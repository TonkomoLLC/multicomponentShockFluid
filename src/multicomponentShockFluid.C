...
#include "multicomponentShockFluid.H"
...
namespace solvers
{
    defineTypeNameAndDebug(multicomponentShockFluid, 0);
    addToRunTimeSelectionTable(solver, multicomponentShockFluid, fvMesh);
}
}
...
void Foam::solvers::multicomponentShockFluid::clearTemporaryFields()
{
    rho_pos.clear();
    rho_neg.clear();
...
Foam::solvers::multicomponentShockFluid::~multicomponentShockFluid()
{}


// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

void Foam::solvers::multicomponentShockFluid::preSolve()
{
    {
        const surfaceScalarField amaxSf
        (
...
void Foam::solvers::multicomponentShockFluid::prePredictor()
{
    fluxPredictor();
    correctDensity();
}
...
void Foam::solvers::multicomponentShockFluid::momentumTransportPredictor()
{
    if (!inviscid)
    {
...
void Foam::solvers::multicomponentShockFluid::thermophysicalTransportPredictor()
{
    if (!inviscid)
    {
...
void Foam::solvers::multicomponentShockFluid::momentumTransportCorrector()
{
    if (!inviscid)
    {
...
void Foam::solvers::multicomponentShockFluid::thermophysicalTransportCorrector()
{
    if (!inviscid)
    {
...
void Foam::solvers::multicomponentShockFluid::postSolve()
{}
